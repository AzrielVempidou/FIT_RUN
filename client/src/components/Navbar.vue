<template>
  <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
    <img src="../assets/Fit & run.png" alt="FitRun Logo" class="w-40 h-40">
    <div class="flex flex-col justify-between flex-1 mt-6">
      <nav>
        <a class="flex items-center px-4 py-2 text-gray-700 bg-gray-200 rounded-md dark:bg-gray-700 dark:text-gray-200"
          ...
          <RouterLink to="/" class="mx-4 font-medium">Dashboard</RouterLink>
        </a>
        ...
        <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
          ...
          <router-link to="/Activties"> <span class="mx-4 font-medium">Activities</span></router-link>
        </a>
        ...
        <span @click.prevent="doLogOut" class="mx-4 font-medium">Log Out</span>
      </a>
    </nav>
